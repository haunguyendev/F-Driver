...
namespace F_Driver.Service.DTO.VNPay
{
    public class CreateVNPayModel
    {
        public CreateVNPayModel() { }
        public CreateVNPayModel(string version, string tmnCode, DateTime createDate, string ipAddress,
